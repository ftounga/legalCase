...
public class AiQuestionService {
    ...
    static final String SYSTEM_PROMPT_TEMPLATE = """
            ...
            - Critères F-DT-75 Congés payés acquis pendant arrêt maladie (droit du travail, FRANCE UNIQUEMENT, binaires — loi 22/04/2024 art. 37, L.3141-5 et L.3141-5-1 CT, Cass. soc. 13/09/2023) : DT75_TYPE_ARRET (le type d'arrêt maladie est-il identifié dans les pièces — maladie non professionnelle vs accident du travail / maladie professionnelle ? Déterminant pour le régime 2 j ou 2,5 j ouvrables/mois), DT75_DUREE_ARRET (la durée cumulée des arrêts maladie est-elle identifiée dans les pièces — base de calcul des jours acquis ?), DT75_SALARIE_EN_POSTE (la situation actuelle du salarié — encore en poste vs sorti — est-elle identifiée dans les pièces ? Déterminant pour le régime de prescription : forclusion 24/04/2026 ou prescription triennale L.3245-1). "expected_value" reste null. Une réponse "oui" = élément documenté.
            - Critères F-DT-39 Prise d'acte de la rupture aux torts de l'employeur (droit du travail, FRANCE UNIQUEMENT, binaires — Cass. soc. 25/06/2003 n°01-42.679, jurisprudence consolidée Cass. soc. 26/03/2014) : DT39_DEFAUT_PAIEMENT (un défaut ou retard de paiement du salaire imputable à l'employeur est-il identifié dans les pièces ?), DT39_HARCELEMENT (un harcèlement moral ou sexuel imputable à l'employeur est-il identifié dans les pièces — attestations, signalement, certificats médicaux ? Grief qui fait basculer l'effet en licenciement NUL), DT39_MANQUEMENT_SECURITE (un manquement à l'obligation de sécurité de l'employeur est-il identifié dans les pièces — accident non déclaré, DUERP absent, RPS ignoré ? L.4121-1 CT), DT39_MODIFICATION_CONTRAT (une modification unilatérale d'un élément essentiel du contrat — rémunération, qualification, durée, lieu — est-elle identifiée dans les pièces ?), DT39_GRIEF_IMPOSSIBLE_POURSUITE (les manquements articulés rendent-ils matériellement impossible la poursuite du contrat — critère jurisprudentiel central, Cass. soc. 26/03/2014 n°12-21.372 ?). "expected_value" reste null. Une réponse "oui" = grief documenté.
            - Critères F-DT-40 Résiliation judiciaire du contrat de travail aux torts de l'employeur (droit du travail, FRANCE UNIQUEMENT, binaires — Cass. soc. 16/03/1989 ; Cass. soc. 20/01/1998 ; art. L.1411-1 CT ; art. 1224, 1227-1228 C.civ.) : DT40_DEFAUT_PAIEMENT (un défaut ou retard de paiement du salaire imputable à l'employeur est-il identifié dans les pièces ?), DT40_HARCELEMENT (un harcèlement moral ou sexuel imputable à l'employeur est-il identifié dans les pièces — attestations, signalement, certificats médicaux ?), DT40_MANQUEMENT_SECURITE (un manquement à l'obligation de sécurité de l'employeur est-il identifié dans les pièces — L.4121-1 CT ?), DT40_MODIFICATION_CONTRAT (une modification unilatérale d'un élément essentiel du contrat est-elle identifiée dans les pièces ?), DT40_MANQUEMENTS_PERSISTANTS (les manquements imputés à l'employeur sont-ils persistants au jour de la demande — Cass. soc. 30/03/2010 n°08-44.236, le juge apprécie au jour de sa décision ?). "expected_value" reste null. Une réponse "oui" = manquement documenté / persistant. ATTENTION : outil distinct de F-DT-39 prise d'acte — la résiliation judiciaire suppose le maintien en poste pendant l'instance (voie moins risquée car le rejet ne rompt pas le contrat).
            - Critères F-DT-36 Licenciement pour faute grave / faute lourde (droit du travail, FRANCE UNIQUEMENT, binaires — L. 1234-1 CT ; L. 1234-9 CT — DISTINCTS des critères DT36_DATE_ENTRETIEN / DT36_MOTIVATION / DT36_ENTRETIEN_TENU nullité de procédure ci-dessus) : DT36_QUALIFICATION_FAUTE (la qualification de la faute disciplinaire est-elle documentée dans les pièces — faute simple / grave / lourde ? La faute grave rend impossible le maintien pendant le préavis ; la faute lourde suppose l'intention de nuire), DT36_PRESCRIPTION_FAUTE (la prescription de 2 mois art. L.1332-4 CT est-elle vérifiée — délai entre connaissance des faits et engagement de la procédure ? Une réponse "oui" = délai respecté / non prescrit ; "non" = faits prescrits), DT36_INTENTION_NUIRE (l'intention de nuire à l'employeur — condition sine qua non de la faute lourde — est-elle documentée dans les pièces ?), DT36_PROCEDURE_DISCIPLINAIRE (la régularité de la procédure disciplinaire est-elle vérifiable dans les pièces : convocation entretien préalable L.1232-2 CT, délai de 5 jours ouvrables, lettre motivée L.1232-6 CT ?). "expected_value" reste null. FRANCE UNIQUEMENT — pas d'équivalent direct côté BE.
            ...
            - Critères F-IM-25 Étranger malade L.425-9 CESEDA (droit de l'immigration, FRANCE UNIQUEMENT, binaires) : IM25_PATHOLOGIE_DOCUMENTEE (une pathologie grave nécessitant des soins est-elle documentée dans les pièces — condition médicale L.425-9 CESEDA ?), IM25_TRAITEMENT_INDISPONIBLE (l'indisponibilité ou l'inaccessibilité du traitement dans le pays d'origine est-elle documentée dans les pièces — critère central L.425-9 ?), IM25_AVIS_OFII (l'avis du collège médical de l'OFII est-il identifié dans les pièces — avis favorable ou défavorable, avec ou sans date ?). "expected_value" reste null. Une réponse "oui" = élément documenté. FRANCE UNIQUEMENT.
