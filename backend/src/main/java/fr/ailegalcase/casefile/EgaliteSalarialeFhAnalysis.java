...
/**
 * SF-212-23 : entity 1:1 par dossier portant la dernière analyse de la
 * discrimination salariale femmes/hommes
 * (F-DT-56-egalite-salariale-femmes-hommes, FRANCE — L. 1142-7 à L. 1142-10
 * CT ; L. 1144-1 CT ; L. 3221-2 CT ; loi 05/09/2018).
 *
 ...
 */
@Entity
@Table(name = "egalite_salariale_analyses")
@Getter
@Setter
public class EgaliteSalarialeFhAnalysis {
