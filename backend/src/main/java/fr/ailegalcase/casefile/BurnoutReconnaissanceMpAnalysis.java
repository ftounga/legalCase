...
/**
 * SF-212-27 : entity 1:1 par dossier portant la dernière analyse de
 ...
 * tableau 57 maladies professionnelles ; CRRMP comité régional de
 * reconnaissance des maladies professionnelles ; circulaire DGT 2016/01).
 *
 ...
 */
@Entity
@Table(name = "burnout_reconnaissance_mp_analyses")
@Getter
@Setter
public class BurnoutReconnaissanceMpAnalysis {
