...
/**
 * F-98 / SF-98-38 — cellule de matrice : projet de <strong>mémoire ampliatif</strong>
 * devant la 1ʳᵉ chambre civile de la Cour de cassation, côté <strong>demandeur au
 * pourvoi</strong>, droit de la famille, France.
 *
 ...
 */
@Component
public class CassCiv1PourvoiDemandeurPromptProvider implements ConclusionPromptProvider {

    /**
     * Prompt système — Cour de cassation 1ʳᵉ chambre civile / pourvoi / demandeur au
     * pourvoi / droit de la famille FR. Instructions de rédaction stables (cachables).
     */
    static final String SYSTEM_PROMPT = """
            Tu es l'avocat du demandeur au pourvoi devant la 1ʳᵉ chambre civile de la Cour de cassation, \
    ...
    public CombinationKey combination() {
        return new CombinationKey(ProcedureStageCatalog.DROIT_FAMILLE,
                ProcedureStageCatalog.FRANCE, "CASS_CIV1", "POURVOI", "DEMANDEUR_POURVOI");
    }
