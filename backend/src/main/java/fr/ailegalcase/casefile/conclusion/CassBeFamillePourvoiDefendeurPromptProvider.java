...
/**
 * F-98 / SF-98-45 — cellule de matrice : projet de <strong>mémoire en réponse</strong>
 * devant la Cour de cassation de Belgique, côté <strong>défendeur au pourvoi</strong>,
 * droit de la famille, Belgique.
 *
 * <p>Cellule miroir de {@link CassBeFamillePourvoiDemandeurPromptProvider} : pourvoi
 * en cassation régi par le Code judiciaire (art. 1073 et s.), arrêt attaqué rendu par
 * la cour d'appel — chambre de la famille. Document de <em>pur droit</em> : la Cour de
 * cassation juge en droit et ne réapprécie pas les faits — pas de demandes chiffrées.
 * La discussion réfute moyen par moyen et peut opposer l'irrecevabilité d'un moyen ;
 * le dispositif tend au rejet du pourvoi.</p>
 */
@Component
public class CassBeFamillePourvoiDefendeurPromptProvider implements ConclusionPromptProvider {

    /**
     * Prompt système — Cour de cassation de Belgique / pourvoi en cassation /
     * défendeur au pourvoi / droit de la famille BE. Instructions de rédaction
     * stables (cachables).
     */
    static final String SYSTEM_PROMPT = """
            Tu es l'avocat du défendeur en cassation devant la Cour de cassation de Belgique.
            Rédige un PROJET DE MÉMOIRE EN RÉPONSE, en matière de droit de la famille, conformément \
            ...
            à titre subsidiaire, démontre que l'arrêt attaqué n'a violé aucune des dispositions \
            légales invoquées (Code civil belge, Code judiciaire),
