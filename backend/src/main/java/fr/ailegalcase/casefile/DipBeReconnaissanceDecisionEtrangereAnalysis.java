...
/**
 * SF-223-08 : entity 1:1 par dossier portant le dernier résultat de la
 * reconnaissance / exequatur d'une décision familiale étrangère BE (CDIP
 ...
 */
@Entity
@Table(name = "dip_be_reconnaissance_decision_etrangere_analyses")
@Getter
@Setter
public class DipBeReconnaissanceDecisionEtrangereAnalysis {
