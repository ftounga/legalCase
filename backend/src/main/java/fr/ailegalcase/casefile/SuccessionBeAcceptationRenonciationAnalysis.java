...
/**
 * SF-217-12 : entity 1:1 par dossier portant le dernier résultat de l'analyse
 * d'option successorale BE (acceptation pure / sous bénéfice d'inventaire /
 * renonciation).
 *
 ...
 */
@Entity
@Table(name = "succession_be_acceptation_renonciation_analyses")
@Getter
@Setter
public class SuccessionBeAcceptationRenonciationAnalysis {
