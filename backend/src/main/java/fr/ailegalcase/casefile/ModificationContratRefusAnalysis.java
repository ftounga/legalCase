...
/**
 * SF-212-11 : entity 1:1 par dossier portant la dernière analyse de
 * modification du contrat refusée par le salarié (F-DT-70, FRANCE — Cass.
 * soc. ; L. 1222-6 CT).
 *
 ...
 */
@Entity
@Table(name = "modification_contrat_refus_analyses")
@Getter
@Setter
public class ModificationContratRefusAnalysis {
