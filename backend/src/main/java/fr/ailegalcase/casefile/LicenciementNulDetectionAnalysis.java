...
/**
 * SF-DT-16-01 : entity 1:1 par dossier portant la dernière analyse de détection
 * licenciement nul (FR — art. L.1235-3-1 al. 2).
 *
 * <p>Stocke un snapshot JSON complet (inputs + résultat) pour pouvoir restituer
 * l'écran de l'avocat tel qu'il l'avait laissé.</p>
 */
@Entity
@Table(name = "licenciement_nul_detection_analyses")
@Getter
@Setter
public class LicenciementNulDetectionAnalysis {
