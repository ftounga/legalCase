...
/**
 * SF-217-08 : entity 1:1 par dossier portant l'analyse de la pension alimentaire
 * entre ex-époux belge (Vague 2 Famille BE — CC art. 301). Outil single-country
 * BELGIQUE.
 *
 ...
 */
@Entity
@Table(name = "contribution_conjoint_be_analyses")
@Getter
@Setter
public class ContributionConjointBeAnalysis {
