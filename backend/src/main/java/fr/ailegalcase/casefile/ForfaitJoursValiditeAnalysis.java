...
/**
 * SF-212-03 : entity 1:1 par dossier portant la dernière analyse de validité
 * d'une convention de forfait jours (FRANCE — L. 3121-58 à L. 3121-66 CT ;
 ...
 */
@Entity
@Table(name = "forfait_jours_validite_analyses")
@Getter
@Setter
public class ForfaitJoursValiditeAnalysis {
