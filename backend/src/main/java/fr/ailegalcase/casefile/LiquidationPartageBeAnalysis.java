...
/**
 * SF-217-02 : entity 1:1 par dossier portant le dernier suivi de la procédure de
 * liquidation-partage post-divorce belge (notaire commis).
 *
 ...
 */
@Entity
@Table(name = "liquidation_partage_be_analyses")
@Getter
@Setter
public class LiquidationPartageBeAnalysis {
