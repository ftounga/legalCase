...
/**
 * SF-DT-24-01 : entity 1:1 par dossier portant la dernière analyse de validité
 * d'une clause de non-concurrence (FR — Cass. soc. 10/07/2002 + L.1221-1).
 *
 * <p>Stocke un snapshot JSON complet (inputs + résultat) pour pouvoir restituer
 * l'écran de l'avocat tel qu'il l'avait laissé.</p>
 */
@Entity
@Table(name = "non_concurrence_analyses")
@Getter
@Setter
public class NonConcurrenceAnalysis {
