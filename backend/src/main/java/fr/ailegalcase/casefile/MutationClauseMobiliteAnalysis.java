...
/**
 * SF-212-13 : entity 1:1 par dossier portant la dernière analyse de validité
 * d'une clause de mobilité et des conséquences d'un refus de mutation
 ...
 */
@Entity
@Table(name = "mutation_clause_mobilite_analyses")
@Getter
@Setter
public class MutationClauseMobiliteAnalysis {
