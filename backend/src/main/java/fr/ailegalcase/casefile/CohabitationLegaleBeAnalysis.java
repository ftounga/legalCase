...
/**
 * SF-223-01 : entity 1:1 par dossier portant le dernier résultat de l'analyse
 * du régime de la cohabitation légale en Belgique (loi du 23/11/1998 ; CC
 * art. 1475-1479 — à vérifier).
 *
 ...
 */
@Entity
@Table(name = "cohabitation_legale_be_analyses")
@Getter
@Setter
public class CohabitationLegaleBeAnalysis {
