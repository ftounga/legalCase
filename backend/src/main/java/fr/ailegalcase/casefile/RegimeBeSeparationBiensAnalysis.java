...
/**
 * SF-223-06 : entity 1:1 par dossier portant le dernier résultat de la
 * qualification du régime de séparation de biens belge (Livre 3 CC ; loi du
 * 22/07/2018 — à vérifier par avocat belge).
 *
 ...
 */
@Entity
@Table(name = "regime_be_separation_biens_analyses")
@Getter
@Setter
public class RegimeBeSeparationBiensAnalysis {
