...
/**
 * SF-212-25 : entity 1:1 par dossier portant la dernière analyse de
 ...
 */
@Entity
@Table(name = "lanceur_alerte_protection_analyses")
@Getter
@Setter
public class LanceurAlerteProtectionAnalysis {
