...
/**
 * SF-212-15 : entity 1:1 par dossier portant la dernière analyse de la
 * conformité du dispositif de télétravail et des litiges courants
 ...
 */
@Entity
@Table(name = "teletravail_accord_analyses")
@Getter
@Setter
public class TeletravailAccordAnalysis {
