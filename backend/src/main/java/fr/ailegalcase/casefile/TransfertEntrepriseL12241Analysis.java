...
/**
 * SF-212-05 : entity 1:1 par dossier portant la dernière analyse de
 * transfert d'entreprise au titre de l'art. L. 1224-1 CT (FRANCE).
 *
 ...
 */
@Entity
@Table(name = "transfert_entreprise_l1224_1_analyses")
@Getter
@Setter
public class TransfertEntrepriseL12241Analysis {
