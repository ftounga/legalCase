...
/**
 * SF-217-18 : entity 1:1 par dossier portant le dernier résultat de l'analyse
 * de recevabilité d'une contestation de filiation BE.
 *
 ...
 */
@Entity
@Table(name = "contestation_filiation_be_analyses")
@Getter
@Setter
public class ContestationFiliationBeAnalysis {
