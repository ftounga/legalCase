...
/**
 * SF-DT-38-01 : entity 1:1 par dossier portant la dernière analyse de
 * qualification d'une rupture pendant la période d'essai (FR).
 *
 * <p>Stocke un snapshot JSON complet (inputs + résultat) pour pouvoir restituer
 * l'écran de l'avocat tel qu'il l'avait laissé.</p>
 */
@Entity
@Table(name = "rupture_periode_essai_analyses")
@Getter
@Setter
public class RupturePeriodeEssaiAnalysis {
