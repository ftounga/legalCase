...
/**
 * SF-217-04 : entity 1:1 par dossier portant l'analyse de l'autorité parentale
 * belge (Vague 2 Famille BE — CC art. 374-375). Outil single-country BELGIQUE.
 *
 * <p>Stocke un snapshot JSON complet (inputs + résultat) pour pouvoir restituer
 * l'écran de l'avocat tel qu'il l'avait laissé.</p>
 */
@Entity
@Table(name = "autorite_parentale_be_analyses")
@Getter
@Setter
public class AutoriteParentaleBeAnalysis {
