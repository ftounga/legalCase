...
/**
 * SF-212-21 : entity 1:1 par dossier portant la dernière analyse de validité
 * d'une démission au regard de la jurisprudence sur la volonté claire et non
 ...
 */
@Entity
@Table(name = "demission_equivoque_analyses")
@Getter
@Setter
public class DemissionEquivoqueAnalysis {
