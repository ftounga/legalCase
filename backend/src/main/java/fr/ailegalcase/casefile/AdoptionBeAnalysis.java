...
/**
 * SF-223-02 : entity 1:1 par dossier portant le dernier résultat de l'analyse
 * de recevabilité de l'adoption en Belgique (loi du 24/04/2003 ; CC art. 343-1
 * et s. — à vérifier).
 *
 ...
 */
@Entity
@Table(name = "adoption_be_analyses")
@Getter
@Setter
public class AdoptionBeAnalysis {
