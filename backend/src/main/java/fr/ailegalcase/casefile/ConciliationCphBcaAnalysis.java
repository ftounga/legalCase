...
/**
 * SF-212-37 : entity 1:1 par dossier portant la dernière analyse de la phase
 * de conciliation au Bureau de Conciliation et d'Orientation (BCO) du CPH
 ...
 */
@Entity
@Table(name = "conciliation_cph_bca_analyses")
@Getter
@Setter
public class ConciliationCphBcaAnalysis {
