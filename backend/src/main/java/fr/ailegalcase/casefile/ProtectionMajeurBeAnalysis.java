...
/**
 * SF-217-14 : entity 1:1 par dossier portant le dernier résultat de l'analyse
 * de protection du majeur incapable BE (statut unique d'administration —
 * loi 17/03/2013).
 *
 ...
 */
@Entity
@Table(name = "protection_majeur_be_analyses")
@Getter
@Setter
public class ProtectionMajeurBeAnalysis {
