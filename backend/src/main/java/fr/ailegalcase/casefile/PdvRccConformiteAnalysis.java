...
/**
 * SF-212-35 : entity 1:1 par dossier portant la dernière analyse de la
 * conformité du PDV / RCC (F-DT-46-pdv-rcc-conformite, FRANCE — L. 1237-17 à
 * L. 1237-19-14 CT).
 *
 ...
 */
@Entity
@Table(name = "pdv_rcc_conformite_analyses")
@Getter
@Setter
public class PdvRccConformiteAnalysis {
