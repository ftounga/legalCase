...
/**
 * SF-212-01 : entity 1:1 par dossier portant la dernière analyse de
 * qualification de la faute disciplinaire (faute grave / faute lourde —
 * FRANCE — L. 1234-1 CT ; L. 1234-9 CT).
 *
 ...
 */
@Entity
@Table(name = "licenciement_faute_grave_lourde_analyses")
@Getter
@Setter
public class LicenciementFauteGraveLourdAnalysis {
