...
/**
 * SF-DT-36-01 : entity 1:1 par dossier portant la dernière analyse des nullités
 * de procédure de licenciement (FR — vices de forme côté employeur).
 *
 * <p>Stocke un snapshot JSON complet (inputs + résultat) pour pouvoir restituer
 * l'écran de l'avocat tel qu'il l'avait laissé.</p>
 */
@Entity
@Table(name = "procedure_nullite_licenciement_analyses")
@Getter
@Setter
public class ProcedureNulliteLicenciementAnalysis {
