...
/**
 * SF-212-29 : entity 1:1 par dossier portant la dernière analyse du congé
 * maternité / paternité (F-DT-77-conge-paternite-maternite, FRANCE —
 * L. 1225-1 à L. 1225-40 CT).
 *
 ...
 */
@Entity
@Table(name = "conge_maternite_paternite_analyses")
@Getter
@Setter
public class CongeMaternitePaterniteAnalysis {
