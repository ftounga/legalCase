...
/**
 * F-98 / SF-98-09 — tests de la cellule CASS_SOC / POURVOI / DEMANDEUR_POURVOI :
 * combinaison déclarée et prompt système (mémoire ampliatif, moyens de cassation,
 * cas d'ouverture, dispositif « casser et annuler », document de pur droit).
 */
class CassSocPourvoiDemandeurPromptProviderTest {

    private final CassSocPourvoiDemandeurPromptProvider provider =
            new CassSocPourvoiDemandeurPromptProvider();

    @Test
    void combination_isWorkCassationSocialPourvoiClaimant() {
