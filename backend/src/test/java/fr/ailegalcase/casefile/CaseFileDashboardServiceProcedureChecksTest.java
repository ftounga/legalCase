...
class CaseFileDashboardServiceProcedureChecksTest {
    ...
    void setUp() {
        ...
        service = new CaseFileDashboardService(
                ...
                mock(AnefProcedureRepository.class),
                mock(MnaEvaluationAgeRepository.class),
                mock(NaturalisationRecoursTjRepository.class),
                ...
                mock(UeEeeSuisseSejourRepository.class),
                mock(RetraitTitreFraudeRepository.class),
                mock(AutorisationTravailEmployeurRepository.class),
