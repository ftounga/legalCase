...
const MOCK_PUBLIC_SHARE: PublicShareResponse = {
  ...
  synthesis: {
    ...
    status: 'DONE',
    faits: [
      { texte: 'Fait 1', source: null, extrait: null },
      { texte: 'Fait 2', source: null, extrait: null },
    ],
    pointsJuridiques: [{ texte: 'Point 1', source: null, extrait: null }],
    risques: [{ texte: 'Risque 1', source: null, extrait: null }],
    questionsOuvertes: [],
    piecesManquantes: [],
