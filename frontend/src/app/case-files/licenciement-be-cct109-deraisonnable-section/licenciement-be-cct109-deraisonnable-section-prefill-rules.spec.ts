import {
  LicenciementBeCct109DeraisonnableSectionPrefillRules as R,
} from './licenciement-be-cct109-deraisonnable-section-prefill-rules';

/**
 * SF-213-10b — tests unitaires du helper pur.
 *
 ...
 */
describe('LicenciementBeCct109DeraisonnableSectionPrefillRules', () => {
    ...
    it('BELGIQUE avec dateLicenciement + salaires → 0 (pas extractible V1)', () => {
      expect(R.computePrefillCount({
        ...
        aiData: {
          ...
          motifLicenciementDetecte: 'Perte de confiance',
        },
      })).toBe(0);
    });
