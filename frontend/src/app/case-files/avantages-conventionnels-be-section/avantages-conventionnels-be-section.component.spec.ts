...
describe('AvantagesConventionnelsBeSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-28-avantages-conventionnels-be/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(AvantagesConventionnelsBeService.STANDALONE_TOOL_ID).toBe('F-DT-28-avantages-conventionnels-be');
      expect(STANDALONE_URL).toContain(AvantagesConventionnelsBeService.STANDALONE_TOOL_ID);
    });
  });
