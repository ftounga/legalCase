...
describe('TravailDissimuleSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-21-travail-dissimule/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(TravailDissimuleService.STANDALONE_TOOL_ID).toBe('F-DT-21-travail-dissimule');
      expect(STANDALONE_URL).toContain(TravailDissimuleService.STANDALONE_TOOL_ID);
    });
  });
