...
describe('ProtectionRpSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-30-protection-rp/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(ProtectionRpService.STANDALONE_TOOL_ID).toBe('F-DT-30-protection-rp');
      expect(STANDALONE_URL).toContain(ProtectionRpService.STANDALONE_TOOL_ID);
    });
  });
