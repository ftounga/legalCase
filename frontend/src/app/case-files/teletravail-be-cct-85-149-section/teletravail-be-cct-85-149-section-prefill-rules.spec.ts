import {
  TeletravailBeCct85149SectionPrefillRules as R,
} from './teletravail-be-cct-85-149-section-prefill-rules';

/**
 * SF-219-16b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — date entrée en vigueur télétravail, type structurel
 * vs occasionnel, flags art. 4-5-6-9 CCT n° 85, montant indemnité forfaitaire,
 * plafond ONSS/SPF Finances, modalités déconnexion Loi 03/10/2022, effectif
 * entreprise non extractibles du dossier salarié principal). On vérifie donc
 * que {@code computePrefillCount} retourne <b>toujours 0</b> quel que soit
 ...
 */
describe('TeletravailBeCct85149SectionPrefillRules', () => {
