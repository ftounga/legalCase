import {
  RccBeLongueCarriereSectionPrefillRules as R,
} from './rcc-be-longue-carriere-section-prefill-rules';

/**
 * SF-219-02b — tests unitaires du helper pur.
 *
 ...
 * de champs IA Travail BE riches (dateLicenciement, dateNaissanceSalarie,
 * salaires bruts, …).</p>
 *
 ...
 */
describe('RccBeLongueCarriereSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec dateLicenciement + dateNaissanceSalarie + salaires → 0 (pas extractible V1)', () => {
      expect(R.computePrefillCount({
        workspaceCountry: 'BELGIQUE',
        aiData: {
          dateLicenciement: '2026-03-15',
          dateNaissanceSalarie: '1965-04-20',
