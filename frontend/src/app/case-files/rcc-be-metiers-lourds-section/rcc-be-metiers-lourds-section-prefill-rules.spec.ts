import {
  RccBeMetiersLourdsSectionPrefillRules as R,
} from './rcc-be-metiers-lourds-section-prefill-rules';

/**
 * SF-219-01b — tests unitaires du helper pur.
 *
 ...
 * motifRupture, anneesCarriereSalarie).</p>
 *
 ...
 */
describe('RccBeMetiersLourdsSectionPrefillRules', () => {
