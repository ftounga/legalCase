import {
  FlexiJobBeSectionPrefillRules as R,
} from './flexi-job-be-section-prefill-rules';

/**
 * SF-219-12b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — date occupation flexi employeur, statut T-3
 * du candidat chez un AUTRE employeur, secteur paritaire flexi, formalisme
 * Dimona FLX, paramètres légaux indexés non extractibles du dossier
 * salarié principal). On vérifie donc que {@code computePrefillCount}
 * retourne <b>toujours 0</b> quel que soit l'input — y compris en présence
 * de champs IA Travail BE riches (dateRuptureContrat, motifRupture,
 * salaireBrutMensuel, anneesCarriereSalarie).</p>
 *
 ...
 */
describe('FlexiJobBeSectionPrefillRules', () => {
