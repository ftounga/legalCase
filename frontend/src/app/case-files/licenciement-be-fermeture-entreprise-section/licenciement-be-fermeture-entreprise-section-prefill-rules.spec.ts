import {
  LicenciementBeFermetureEntrepriseSectionPrefillRules as R,
} from './licenciement-be-fermeture-entreprise-section-prefill-rules';

/**
 * SF-219-06b — tests unitaires du helper pur.
 *
 ...
 * dateEntreeSalarie, motifRupture).</p>
 *
 ...
 */
describe('LicenciementBeFermetureEntrepriseSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec motifRupture=fermeture → 0', () => {
      expect(R.computePrefillCount({
        workspaceCountry: 'BELGIQUE',
        aiData: { motifRupture: 'fermeture' },
      })).toBe(0);
    });
