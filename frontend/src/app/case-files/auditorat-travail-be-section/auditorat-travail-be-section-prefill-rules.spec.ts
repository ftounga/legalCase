import {
  AuditoratTravailBeSectionPrefillRules as R,
} from './auditorat-travail-be-section-prefill-rules';

/**
 * SF-219-25b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — nature des faits, mode de saisine, date faits,
 * prescription, inspection saisie, plainte civile, urgence, recours
 * pénal, personne morale non extractibles du dossier salarié principal
 * — relèvent de l'analyse pénale / dossier d'instruction / stratégie
 * avocat). On vérifie donc que {@code computePrefillCount}
 ...
 */
describe('AuditoratTravailBeSectionPrefillRules', () => {
