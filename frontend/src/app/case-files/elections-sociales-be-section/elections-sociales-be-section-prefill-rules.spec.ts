import {
  ElectionsSocialesBeSectionPrefillRules as R,
} from './elections-sociales-be-section-prefill-rules';

/**
 * SF-219-09b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — qualifications procédurales / cycle imposé par AR /
 * effectif ETP RH employeur / UTE paritaire non extractibles). On vérifie
 * donc que {@code computePrefillCount} retourne <b>toujours 0</b> quel
 * que soit l'input — y compris en présence de champs IA Travail BE riches
 ...
 */
describe('ElectionsSocialesBeSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec champs Travail BE riches → 0 (V1)', () => {
      expect(R.computePrefillCount({
        ...
        aiData: {
          dateNaissanceSalarie: '1970-06-15',
