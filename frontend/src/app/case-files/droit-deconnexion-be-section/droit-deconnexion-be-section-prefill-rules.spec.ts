import {
  DroitDeconnexionBeSectionPrefillRules as R,
} from './droit-deconnexion-be-section-prefill-rules';

/**
 * SF-219-19b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — effectif employeur, statut accord, date entrée
 * en vigueur instrument, modalités pratiques / sensibilisation /
 * organisation, consultation organe concertation, manquement signalé
 * CBE/SPF non extractibles du dossier salarié principal — déclaratifs
 * RH employeur ou avocat). On vérifie donc que
 ...
 */
describe('DroitDeconnexionBeSectionPrefillRules', () => {
