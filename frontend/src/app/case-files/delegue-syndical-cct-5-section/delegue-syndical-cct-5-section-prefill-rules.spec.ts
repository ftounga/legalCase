import {
  DelegueSyndicalCct5SectionPrefillRules as R,
} from './delegue-syndical-cct-5-section-prefill-rules';

/**
 * SF-219-10b — tests unitaires du helper pur.
 *
 ...
 */
describe('DelegueSyndicalCct5SectionPrefillRules', () => {
    ...
    it('BELGIQUE avec champs Travail BE riches → 0 (V1)', () => {
      expect(R.computePrefillCount({
        ...
        aiData: {
          ...
          motifRupture: 'licenciement individuel',
