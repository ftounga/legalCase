import {
  EcoChequesChequesRepasBeSectionPrefillRules as R,
} from './eco-cheques-cheques-repas-be-section-prefill-rules';

/**
 * SF-219-21b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — type d'avantage, montants, jours prestés, flags
 * juridiques (CCT, convention individuelle, paiement électronique,
 * cumul frais de bouche, substitution rémunération), date d'attribution
 * non extractibles du dossier salarié principal — déclaratifs RH /
 * fiches de paie / avocat). On vérifie donc que
 ...
 * (dateRuptureContrat, salaireBrutMensuel, salaireBrutAnnuel).</p>
 *
 ...
 */
describe('EcoChequesChequesRepasBeSectionPrefillRules', () => {
