...
describe('LicenciementEconomiqueSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-13-licenciement-economique/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(LicenciementEconomiqueService.STANDALONE_TOOL_ID).toBe('F-DT-13-licenciement-economique');
      expect(STANDALONE_URL).toContain(LicenciementEconomiqueService.STANDALONE_TOOL_ID);
    });
  });
