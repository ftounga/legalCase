...
describe('CreditTempsBeSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-29-credit-temps-be/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(CreditTempsBeService.STANDALONE_TOOL_ID).toBe('F-DT-29-credit-temps-be');
      expect(STANDALONE_URL).toContain(CreditTempsBeService.STANDALONE_TOOL_ID);
    });
  });
