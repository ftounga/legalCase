import {
  TransfertEntrepriseCct32bisSectionPrefillRules as R,
} from './transfert-entreprise-cct-32bis-section-prefill-rules';

/**
 * SF-219-08b — tests unitaires du helper pur.
 *
 ...
 */
describe('TransfertEntrepriseCct32bisSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec motifRupture=transfert → 0', () => {
      expect(R.computePrefillCount({
        workspaceCountry: 'BELGIQUE',
        aiData: { motifRupture: 'transfert' },
      })).toBe(0);
    });
