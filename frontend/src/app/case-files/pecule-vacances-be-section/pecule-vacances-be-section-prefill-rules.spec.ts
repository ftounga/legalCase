import {
  PeculeVacancesBeSectionPrefillRules as R,
} from './pecule-vacances-be-section-prefill-rules';

/**
 * SF-219-20b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — statut employé/ouvrier/jeune travailleur, type
 * calcul simple/double/départ, montants rémunération exercice de
 * vacances, jours congés pris, flag pécule déjà payé, date sortie /
 * fin contrat / réclamation non extractibles du dossier salarié
 ...
 */
describe('PeculeVacancesBeSectionPrefillRules', () => {
