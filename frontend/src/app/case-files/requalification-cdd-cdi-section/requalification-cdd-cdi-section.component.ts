...
export class RequalificationCddCdiSectionComponent implements OnInit, OnChanges {
  ...
  static getPrefillCount(input: {
    ...
    return RequalificationCddCdiSectionPrefillRules.computePrefillCount({
      aiData: input.aiData,
  ...
  private prefillFromAi(): void {
    ...
    const salaire = RequalificationCddCdiSectionPrefillRules.computeSalaireMensuelBrutEur({
