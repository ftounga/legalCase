import {
  CodePenalSocialBeSectionPrefillRules as R,
} from './code-penal-social-be-section-prefill-rules';

/**
 * SF-219-24b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — type infraction, niveau proposé, date faits,
 * nombre travailleurs, personne morale, récidive, qualité auteur,
 * élément moral non extractibles du dossier salarié principal —
 * relèvent de l'analyse pénale / procès-verbal d'inspection sociale /
 * dossier auditorat). On vérifie donc que {@code computePrefillCount}
 ...
 */
describe('CodePenalSocialBeSectionPrefillRules', () => {
