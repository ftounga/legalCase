import {
  OutplacementBeGeneral30semSectionPrefillRules as R,
} from './outplacement-be-general-30sem-section-prefill-rules';

/**
 * SF-219-05b — tests unitaires du helper pur.
 *
 ...
 * de champs IA Travail BE riches (motifRupture, dateRuptureContrat,
 ...
 */
describe('OutplacementBeGeneral30semSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec motifRupture + dateRuptureContrat → 0 (pas extractible V1)', () => {
    ...
    it('workspaceCountry absent → 0', () => {
      expect(R.computePrefillCount({
        aiData: { dateRuptureContrat: '2026-12-31' },
      })).toBe(0);
    });
  });
