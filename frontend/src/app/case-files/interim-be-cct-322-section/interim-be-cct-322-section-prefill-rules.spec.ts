import {
  InterimBeCct322SectionPrefillRules as R,
} from './interim-be-cct-322-section-prefill-rules';

/**
 * SF-219-14b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — date mission ETI, motif, durée cumulée, parité
 * salariale utilisateur, formalisme Dimona ETI, paramètres légaux du
 * plafond non extractibles du dossier salarié principal). On vérifie donc
 ...
 */
describe('InterimBeCct322SectionPrefillRules', () => {
