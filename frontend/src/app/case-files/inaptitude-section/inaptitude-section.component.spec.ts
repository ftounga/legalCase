...
describe('InaptitudeSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-15-inaptitude/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(InaptitudeService.STANDALONE_TOOL_ID).toBe('F-DT-15-inaptitude');
      expect(STANDALONE_URL).toContain(InaptitudeService.STANDALONE_TOOL_ID);
    });
  });
