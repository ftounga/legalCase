import {
  TransactionBeTravailSectionPrefillRules as R,
} from './transaction-be-travail-section-prefill-rules';

/**
 * SF-213-06b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (analyse sémantique du document de transaction hors scope, cf. doc
 * du helper). On vérifie donc que {@code computePrefillCount} retourne
 ...
 */
describe('TransactionBeTravailSectionPrefillRules', () => {
  ...
  describe('V1 — invariant : count toujours 0', () => {
    ...
    it('BELGIQUE avec champs IA Travail BE riches → 0 (rien d\'extractible V1)', () => {
