import {
  SuccessionBeAcceptationRenonciationSectionPrefillRules,
  computePrefillCount,
} from './succession-be-acceptation-renonciation-section-prefill-rules';

describe('SuccessionBeAcceptationRenonciationSectionPrefillRules — SF-217-13', () => {
  ...
  it('expose le barrel SuccessionBeAcceptationRenonciationSectionPrefillRules', () => {
    expect(
      SuccessionBeAcceptationRenonciationSectionPrefillRules.computePrefillCount,
