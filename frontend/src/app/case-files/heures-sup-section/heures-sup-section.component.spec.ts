...
describe('HeuresSupSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-19-heures-sup/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(HeuresSupService.STANDALONE_TOOL_ID).toBe('F-DT-19-heures-sup');
      expect(STANDALONE_URL).toContain(HeuresSupService.STANDALONE_TOOL_ID);
    });
  });
