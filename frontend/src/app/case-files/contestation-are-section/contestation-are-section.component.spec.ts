...
describe('ContestationAreSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-35-contestation-are-fr/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(ContestationAreService.STANDALONE_TOOL_ID).toBe('F-DT-35-contestation-are-fr');
      expect(STANDALONE_URL).toContain(ContestationAreService.STANDALONE_TOOL_ID);
    });
  });
