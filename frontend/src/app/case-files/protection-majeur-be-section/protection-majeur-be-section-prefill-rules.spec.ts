import {
  ProtectionMajeurBeSectionPrefillRules,
  computePrefillCount,
} from './protection-majeur-be-section-prefill-rules';

describe('ProtectionMajeurBeSectionPrefillRules — SF-217-15', () => {
  ...
  it('expose le barrel ProtectionMajeurBeSectionPrefillRules', () => {
    expect(
      ProtectionMajeurBeSectionPrefillRules.computePrefillCount,
