...
describe('RappelSalaireSectionPrefillRules', () => {
  ...
  it('expose RappelSalaireSectionPrefillRules barrel', () => {
    expect(RappelSalaireSectionPrefillRules.computePrefillCount).toBe(computePrefillCount);
  });
});
