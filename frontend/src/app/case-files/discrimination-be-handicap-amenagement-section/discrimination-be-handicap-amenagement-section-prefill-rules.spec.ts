import {
  DiscriminationBeHandicapAmenagementSectionPrefillRules as R,
} from './discrimination-be-handicap-amenagement-section-prefill-rules';

/**
 * SF-219-23b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — statut handicap, demande aménagement, avis SEPP,
 * réponse employeur, motivation détaillée, devis externe, mesures
 * alternatives, sanction, etc. non extractibles du dossier salarié
 * principal — déclaratifs RH employeur / médecin du travail / avocat).
 * On vérifie donc que {@code computePrefillCount} retourne
 * <b>toujours 0</b> quel que soit l'input — y compris en présence de
 ...
 */
describe('DiscriminationBeHandicapAmenagementSectionPrefillRules', () => {
