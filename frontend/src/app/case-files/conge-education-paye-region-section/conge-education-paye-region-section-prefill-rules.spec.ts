import {
  CongeEducationPayeRegionSectionPrefillRules as R,
} from './conge-education-paye-region-section-prefill-rules';

/**
 * SF-219-11b — tests unitaires du helper pur.
 *
 ...
 */
describe('CongeEducationPayeRegionSectionPrefillRules', () => {
