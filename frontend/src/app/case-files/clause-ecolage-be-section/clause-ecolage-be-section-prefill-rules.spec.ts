import {
  ClauseEcolageBeSectionPrefillRules as R,
} from './clause-ecolage-be-section-prefill-rules';

/**
 * SF-219-17b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — type formation, forme écrite, coût réel, RMMMG
 * mensuel CCT n° 43, durée d'efficacité, dates fin formation / départ,
 * qualification motif art. 22bis § 3 non extractibles du dossier salarié
 * principal). On vérifie donc que {@code computePrefillCount} retourne
 ...
 */
describe('ClauseEcolageBeSectionPrefillRules', () => {
