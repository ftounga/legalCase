import {
  TravailNoirBeDimonaSectionPrefillRules as R,
} from './travail-noir-be-dimona-section-prefill-rules';

/**
 * SF-219-26b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — statut DIMONA, dates, salaire période non
 * déclarée, nombre travailleurs, personne morale, récidive, éléments
 * subordination non extractibles du dossier salarié — relèvent du
 * procès-verbal d'inspection sociale / extrait ONSS / audition
 * travailleur). On vérifie que {@code computePrefillCount} retourne
 ...
 */
describe('TravailNoirBeDimonaSectionPrefillRules', () => {
