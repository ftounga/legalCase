...
describe('AtMpSectionComponent', () => {
  ...
  describe('F-163 SF-163-02b — mode standalone', () => {
    const STANDALONE_URL = '/api/v1/simulators/F-DT-33-at-mp/calculate';
    ...
    it("CA-09 : exposition du service standalone (route dispatcher)", () => {
      ...
      expect(AtMpService.STANDALONE_TOOL_ID).toBe('F-DT-33-at-mp');
      expect(STANDALONE_URL).toContain(AtMpService.STANDALONE_TOOL_ID);
    });
  });
