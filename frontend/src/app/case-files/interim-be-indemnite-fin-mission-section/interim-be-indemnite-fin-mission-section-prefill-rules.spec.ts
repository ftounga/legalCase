import {
  InterimBeIndemniteFinMissionSectionPrefillRules as R,
} from './interim-be-indemnite-fin-mission-section-prefill-rules';

/**
 * SF-219-15b — tests unitaires du helper pur.
 *
 * <p>V1 : aucun champ pré-remplissable depuis {@code TravailExtractedData}
 * (cf. doc du helper — dates mission ETI / durées prestation / salaire
 * horaire intérimaire / relevés d'heures / pécule FSI / qualification
 * rupture / CP utilisateur / ancienneté sectorielle non extractibles
 * du dossier salarié principal). On vérifie donc que
 ...
 */
describe('InterimBeIndemniteFinMissionSectionPrefillRules', () => {
