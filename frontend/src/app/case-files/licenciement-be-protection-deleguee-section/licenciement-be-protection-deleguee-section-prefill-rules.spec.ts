import {
  LicenciementBeProtectionDelegueeSectionPrefillRules as R,
} from './licenciement-be-protection-deleguee-section-prefill-rules';

/**
 * SF-213-08b — tests unitaires du helper pur.
 *
 ...
 */
describe('LicenciementBeProtectionDelegueeSectionPrefillRules', () => {
