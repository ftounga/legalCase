# M-41 — Liste de 50 cabinets cibles
## Droit du travail — Paris / Île-de-France
...
## Tableau de suivi (à dupliquer dans Notion / Google Sheets)

| # | Prénom | Cabinet | Date envoi | Statut | Notes |
|---|--------|---------|-----------|--------|-------|
| — | — | — | — | Prospect | — |

Statuts possibles : `Prospect` → `Contacté` → `Répondu` → `Démo planifiée` → `Client` / `Pas intéressé`
