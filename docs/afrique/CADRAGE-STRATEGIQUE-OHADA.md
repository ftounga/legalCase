...
|---|-------|----------|---------------|
| D1 | **Architecture produit** | **Produit séparé**, infra Afrique dédiée. Codebase partagée au départ (réutilisation ~90 % du moteur dossier-centric), mais déploiement, marque et roadmap **indépendants**. Satisfait nativement la résidence des données et porte un dossier de levée/subvention autonome. | Arbitré 2026-06-03 |
