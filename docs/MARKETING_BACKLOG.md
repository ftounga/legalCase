...
| M-65 | Partenariat éditorial Belgique | Moyenne | `En cours` | Cibles : Jubel.be, Droitbelge.be, Justice-en-ligne.be. Publication sponsorisée ou tribune. Budget estimé : 200-500€ (à évaluer au contact). **2026-05-06 — Mails envoyés** : (1) **Jubel.be** (KnopsPublishing BV, info@mijnwetboek.be) — Gmail ID 19dfc6b408336eb3, propose tribune 800-1 200 mots ou interview portrait solo founder ; (2) **Droitbelge.be** (contact@droitbelge.be) — Gmail ID 19dfc6b422f055b4, propose article expert / mention rubrique nouveautés / tribune entrepreneuriale ; (3) **Justice-en-ligne.be** (asbl Institut d'Études sur la Justice, pas d'email direct exposé) — draft prêt dans `~/dev/saf-batch/be-campaign/m65_partenariats_editoriaux.py` à soumettre via formulaire web https://www.justice-en-ligne.be/spip.php?page=contact (audience grand public — angle vulgarisation pédagogique gratuite, pas démarchage). Surveillance J+5 = 2026-05-11. Pas de budget engagé à ce stade — bascule à `Rédigé` (avec budget) ou `Terminé` (publication effective) selon retours. Capitalise sur la vague BE M-64 en flight (1 995 avocats touchés cette semaine) comme entrée en matière. |
