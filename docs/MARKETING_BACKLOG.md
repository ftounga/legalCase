...
| M-64 | Liste cabinets cibles Belgique + outreach | Moyenne | `Rédigé` | **Base prête 2026-05-06 :** scraper `~/dev/saf-batch/be-scrape/scraper.py` a extrait **1 995 avocats francophones** depuis `avocats.be` (POST direct sur `/lawyersapisearch`, sans Sales Navigator) — fichier `belgique_avocats.json`. Couverture : 4 matières (Droit du travail 344, Droit social 368, Droit des étrangers 343, Droit de la famille 1 353), 10 barreaux (BXF 846 / LIE 296 / CHA 220 / NIV 171 / NAM 150 / MON 107 / TOU 103 / VER 48 / LUX 40 / EUP 14). 99.5 % @avocat.be (alias institutionnel). **Reste à faire avant `Terminé`** : (1) rédiger template BE-spécifique (CCT 109, tribunal du travail, pas Cloud Act mais RGPD, Calendly), (2) valider sur sample 50, (3) cadence 500/jour (limite Workspace), (4) attendre fin A/B SAF (≥ 2026-05-15) pour ne pas brouiller la mesure. |
