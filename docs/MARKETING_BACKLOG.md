...
| M-59 | Hébergement souverain — badge + section landing page | Haute | `À faire` | Rendre visible l'avantage AWS eu-west-3 Paris face au Cloud Act des concurrents US (Harvey, Luminance, CoCounsel). Badge "Données hébergées en France" + section dédiée sur la landing page. Zéro nouveau dev infrastructure — juste du contenu et du frontend minimal. |
| M-60 | Hébergement souverain — argument pitch deck et outreach | Haute | `À faire` | Ajouter 1 slide "Souveraineté des données" au pitch deck M-40. Mettre à jour les templates outreach M-42 avec l'argument Cloud Act. Viser les cabinets traitant des dossiers confidentiels (restructuration, pénal des affaires, RH sensible). |
| M-61 | Hébergement souverain — post LinkedIn comparatif | Haute | `À faire` | Post "Vos données juridiques passent-elles par les États-Unis ?" — explication Cloud Act, comparaison Harvey/Luminance vs AI LegalCase, proof AWS eu-west-3 Paris. Format éducatif, pas publicitaire. |
