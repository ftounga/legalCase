...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. Rappel : les alertes sont purement visuelles, aucune action n'est bloquée techniquement. **Droit du travail** (3/3 couverts) : F-DT-08 Validité licenciement FR+BE (SF-IA-03-01/02/03), F-DT-07 Ancienneté (SF-IA-03-04), F-DT-09 Indemnités (SF-IA-03-05). **Droit de la famille** (3/3 couverts) : F-FA-07 Checklist divorce (SF-IA-03-06), F-FA-06 Calendrier garde (SF-IA-03-07), F-FA-05 Partage immobilier (SF-IA-03-08). **Droit de l'immigration** (2/3) : F-IM-05 Titre séjour (SF-IA-03-09), F-IM-06 Recours (SF-IA-03-10, recoursType enum + dateNotification seuil 7j strict). Reste à faire : F-IM-07 Droit au travail (ROI limité, à évaluer), niveau `info` et justification obligatoire si blocker. |
