...
| F-111 | Tableau de bord opérationnel workspace | V4 — **Terminée** | Page `/dashboard` affichée à la connexion. 4 sections : dossiers ouverts (cartes cliquables + compteur), délais urgents J+7 (badge J-X rouge/orange), alertes checklist NON_COMPLIANT > 7j, 5 dernières analyses. SF-111-01 mergée 2026-04-04 : GET /api/v1/dashboard, 612 tests verts. SF-111-02 mergée 2026-04-04 : DashboardComponent, route /dashboard, lien sidenav, redirection post-login, 641 tests verts. |
