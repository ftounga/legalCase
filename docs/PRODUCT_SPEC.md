...
| F-117 | SEO — Mots-clés métier dans meta tags + structured data JSON-LD | V5 — **Terminée** | Title et meta description enrichis avec mots-clés métier (avocat, droit du travail, contentieux, cabinet). JSON-LD SoftwareApplication injecté par LandingComponent, présent dans le HTML pré-rendu SSG. OG et Twitter Card cohérents. SF-117-01 mergée 2026-04-06. 657 tests verts. |
...
|------|-------------|------------|
| 2026-04-06 | F-117 Terminée — SF-117-01 mergée : title/description enrichis mots-clés métier, JSON-LD SoftwareApplication, OG/Twitter Card cohérents, 657 tests verts | Product owner |
