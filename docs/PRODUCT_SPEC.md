...
| F-FA-06 | Calendrier de garde et droit de visite | `À spécifier` | Génération d'un calendrier type (résidence alternée, DVH classique, garde élargie) conforme aux usages des JAF (FR) et tribunaux de la famille (BE). Export PDF pour annexe à la convention. France + Belgique. |
