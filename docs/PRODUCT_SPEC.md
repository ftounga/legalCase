...
| F-DT-07 | Barème d'ancienneté et congés conventionnels | `À spécifier` | Calcul automatique des droits à congés et primes d'ancienneté selon la convention collective (FR) et la commission paritaire (BE). Détection des écarts entre contrat et minimum légal. France + Belgique. |
