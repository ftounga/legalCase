...
| F-119 | Tracking conversion Google Ads | V7 — `À spécifier` | Tag de conversion Google Ads déclenché à l'inscription. Capture des paramètres UTM et gclid depuis l'URL. Transmission à GA4 et Google Ads via gtag. Permet de mesurer le ROI des campagnes payantes (M-56). |
