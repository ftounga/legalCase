...
| F-IM-06 | Générateur de recours préfectoral / CGRA | `À spécifier` | Modèle de recours pré-rempli à partir du dossier : recours gracieux ou contentieux TA (FR), recours CGRA/CCE (BE). Inclut visa des textes, délais calculés depuis la notification, pièces à joindre. France + Belgique. |
