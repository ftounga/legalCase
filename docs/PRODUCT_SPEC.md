...
| F-FA-07 | Checklist divorce par consentement mutuel | `À spécifier` | Pièces et étapes procédurales pour un divorce amiable : convention + dépôt notaire (FR), requête conjointe tribunal de la famille (BE). Suivi d'avancement avec alertes de délai. France + Belgique. |
