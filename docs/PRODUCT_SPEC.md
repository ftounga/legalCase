...
| F-DT-07 | Barème d'ancienneté et congés conventionnels | `En cours` | Calcul automatique des droits à congés et primes d'ancienneté selon la convention collective (FR) et la commission paritaire (BE). Détection des écarts entre contrat et minimum légal. France + Belgique. SF-DT-07-01 mergée 2026-04-07 (référentiel 8 conventions FR/BE, calculateur ancienneté/congés/prime/écarts, migration 061, 17 tests). |
