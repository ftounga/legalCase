...
| F-69 | Suivi des délais légaux | V2 — **En cours** | Associer des échéances à un dossier (prescription, délai d'appel, délai de réponse). Alertes J-15 et J-7. Affichage dans la page dossier. Scoped au workspace. SF-69-01 mergée 2026-03-29 (backend CRUD, migration 037). SF-69-02 à faire (frontend). SF-69-03 à faire (alertes). |
