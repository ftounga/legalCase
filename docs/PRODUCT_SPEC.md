...
| F-IM-06 | Générateur de recours préfectoral / CGRA | `En cours` | Modèle de recours pré-rempli à partir du dossier : recours gracieux ou contentieux TA (FR), recours CGRA/CCE (BE). Inclut visa des textes, délais calculés depuis la notification, pièces à joindre. France + Belgique. SF-IM-06-01 mergée 2026-04-07 (référentiel 6 types recours FR/BE, générateur document structuré, entity 1:1, migration 059, 17 tests). SF-IM-06-02 mergée 2026-04-07 (endpoint POST/GET recours, validation, upsert, isolation workspace, 8 IT). |
