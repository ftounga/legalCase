...
| ID | Feature | Cible | Notes |
|----|---------|-------|-------|
| F-IM-01 | Checklist pièces par type de titre | V4 — **En cours** | Checklist interactive typée par procédure (visa étudiant, titre salarié, regroupement familial, naturalisation), différenciée France/Belgique, persistée en DB. SF-IM-01-01 mergée 2026-04-04 (ImmigrationPieceReferentiel 4×2, table immigration_piece_checks, GET+PUT isolation workspace, 550 tests). SF-IM-01-02 (frontend) et SF-IM-01-03 (export PDF) à venir. |
