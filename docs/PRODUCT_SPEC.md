...
| F-113 | Centre de notifications in-app | V5 — **Backlog** | Icône cloche dans le header avec badge compteur. Panneau listant les événements récents : analyse terminée, délai urgent approchant (J-7/J-3), alerte checklist NON_COMPLIANT, signalement référentiel. Polling 60s ou SSE. Marquer lu / tout marquer lu. Complète les emails existants sans quitter l'app. |
