...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. SF-IA-03-01 mergée 2026-04-13 (PR #314) : 1er cas d'usage F-DT-08 FR+BE, source unique = détection IA exposée par SF-IA-01-03, 2 niveaux warning/blocker selon criticité du critère, tooltip avec justification IA, compteur global. Reste à faire : ajouter sources checklist procédurale F-96 + pièces manquantes + questions IA interactives, étendre aux autres outils (F-DT-07, F-DT-09, F-FA-*, F-IM-*), introduire le niveau `info` et la justification obligatoire si blocker. |
