...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. Rappel : les alertes sont purement visuelles, aucune action n'est bloquée techniquement. **Droit du travail** (3/3 outils couverts) : F-DT-08 Validité licenciement FR+BE (SF-IA-03-01/02/03, 4 sources), F-DT-07 Ancienneté (SF-IA-03-04, IA + seuils), F-DT-09 Indemnités (SF-IA-03-05, modèle `expected_value` pour enum). **Droit de la famille** (3/3 outils couverts) : F-FA-07 Checklist divorce FR+BE (SF-IA-03-06, 13 étapes + 17 pièces), F-FA-06 Calendrier garde FR+BE (SF-IA-03-07, 6 modes enum), F-FA-05 Partage immobilier (SF-IA-03-08, 2 champs numériques avec best-match). Reste à faire : F-IM-05/06/07, niveau `info` et justification obligatoire si blocker. |
