...
| ID | Feature | Cible | Notes |
|----|---------|-------|-------|
| F-FA-01 | Calcul de la prestation compensatoire | V4 — **En cours** | Calculateur backend : durée du mariage, revenus des deux parties, patrimoine, âge. Résultat affiché comme fourchette indicative avec les facteurs retenus. SF-FA-01-01 mergée 2026-04-04 (PrestationCompensatoireCalculator art. 271 Cciv, coeff FR 0.30/BE 0.25, fourchette ±15 %, prompt DROIT_FAMILLE enrichi, 574 tests). SF-FA-01-02 (frontend) à venir. |
