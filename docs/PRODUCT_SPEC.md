...
| F-71 | Sections repliables — délais et notes | V2 — En cours | Rendre les sections Délais légaux et Notes internes de la page dossier repliables/dépliables via un clic sur le header. Badge compteur affiché quand la section est repliée. État géré par signal Angular. SF-71-01 en cours. |
...
| F-67 | Wizard d'onboarding guidé | V2 — En cours | Wizard d'onboarding étendu en product tour interactif 5 étapes (carte flottante non-bloquante, surlignage des éléments UI, cross-navigation). SF-67-01 mergée 2026-03-29 (dialog). SF-67-02 en cours (product tour). |
