...
| F-56 | Diff sémantique avec attribution des raisons | V2 — **Terminée** | Amélioration de F-54. Remplacement du diff exact par un diff sémantique via Haiku (4 états : ajouté/supprimé/inchangé/enrichi-bleu). Snapshot des documents par analyse via table `analysis_documents`. Attribution de la raison par item : document ajouté/supprimé pour STANDARD vs STANDARD, réponse Q&R pour STANDARD vs ENRICHIE. Tooltip au survol des items colorés. Cache du résultat sémantique par paire (fromId, toId). SF-56-01 mergée 2026-03-27 : migration 030, AnalysisDocumentSnapshot, AnalysisDocumentSnapshotService. SF-56-02 mergée 2026-03-27 : SemanticDiffService (Haiku + fallback exact), cache 031, AnalysisDiffResponse 4 états, 17 tests. SF-56-03 mergée 2026-03-27 : frontend enriched bleu, matTooltip reason, totalEnriched/sectionEnrichedCount, 14 tests. |
