...
| F-IM-07 | Analyse droit au travail du demandeur | `À spécifier` | Détermination automatique du droit au travail selon le statut migratoire : APT / autorisation incluse dans le titre (FR), permis unique / attestation d'immatriculation (BE). Obligations employeur (vérification préfecture FR, Dimona BE). France + Belgique. |
