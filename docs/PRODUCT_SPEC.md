...
|------|-------------|------------|
| 2026-04-01 | F-93 Terminée — SF-93-02 mergée : AnalysisItem model frontend, badge source dans SynthesisComponent, PDF adapté, 418 tests | Product owner |
