...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. Rappel : les alertes sont purement visuelles, aucune action n'est bloquée techniquement. **F-DT-08 Validité licenciement** FR+BE (SF-IA-03-01/02/03) : 4 sources agrégées (F-96, question IA, détection IA, pièce manquante), hiérarchie stricte F-96 > QUESTION_IA > IA > PIECE_MANQUANTE, source MULTI si convergence. **F-DT-07 Ancienneté** (SF-IA-03-04) : source unique détection IA, warning uniquement sur 5 champs avec seuils calibrés. **F-DT-09 Indemnités** (SF-IA-03-05) : 3 champs (type de rupture, ancienneté, salaire), extension modèle `expected_value` pour critères énumérés, blocker sur type de rupture / warning sur numériques. Reste à faire : F-FA-*, F-IM-*, niveau `info` et justification obligatoire si blocker. |
