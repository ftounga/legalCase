...
| F-DT-09 | Comparateur jurisprudentiel d'indemnités | `À spécifier` | À partir du profil du salarié (ancienneté, âge, poste, secteur), fourchettes d'indemnités observées en jurisprudence récente — Conseil de prud'hommes (FR) et Tribunal du travail (BE). France + Belgique. |
