...
| F-DT-08 | Analyse de validité du licenciement | `À spécifier` | Grille d'analyse IA des motifs de licenciement : vérification des conditions de forme (entretien préalable FR, audition préalable BE), délais, motivation suffisante. Score de risque de requalification. France + Belgique. |
