...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. Rappel : les alertes sont purement visuelles, aucune action n'est bloquée techniquement. SF-IA-03-01 mergée 2026-04-13 (PR #314) : 1er cas d'usage F-DT-08 FR+BE, source détection IA. SF-IA-03-02 mergée 2026-04-13 (PR #315) : ajout source checklist procédurale F-96 (priorité F-96 > IA, blocker systématique si F-96 validé contredit). Reste à faire : sources pièces manquantes + questions IA interactives, extension aux autres outils (F-DT-07, F-DT-09, F-FA-*, F-IM-*), niveau `info` et justification obligatoire si blocker. |
