...
| F-IA-03 | Contrôle de cohérence IA sur les outils décisionnels | `En cours` | Lorsque l'avocat saisit une réponse dans un outil décisionnel, le moteur compare sa réponse aux preuves disponibles et alerte en cas de contradiction. Rappel : les alertes sont purement visuelles, aucune action n'est bloquée techniquement. Moteur livré pour F-DT-08 FR+BE avec 4 sources agrégées : F-96 (SF-IA-03-02), questions IA répondues (SF-IA-03-03), détection IA (SF-IA-03-01), pièces manquantes (SF-IA-03-03). Priorité stricte F-96 > QUESTION_IA > IA > PIECE_MANQUANTE, source MULTI si plusieurs preuves convergent. Reste à faire : extension aux autres outils (F-DT-07, F-DT-09, F-FA-*, F-IM-*), niveau `info` et justification obligatoire si blocker. |
