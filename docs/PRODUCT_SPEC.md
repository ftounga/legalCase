...
| F-IM-03 | Calendrier procédural préfectoral | V4 — **À spécifier** | Absorbée dans F-69 (extension) — référentiel de délais types par procédure préfectorale (OFPRA, CNDA, renouvellement) injecté uniquement pour DROIT_IMMIGRATION. Génère des `CaseDeadline` depuis le référentiel, pas de nouvelle table. |
