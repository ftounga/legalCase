...
| F-FA-05 | Simulateur partage des biens immobiliers | `À spécifier` | Calcul de la soulte en cas de partage d'un bien immobilier commun : valeur vénale, capital restant dû, quote-part, droit de partage 1.1% (FR) / droits d'enregistrement (BE). France + Belgique. |
