...
| F-118 | Refonte visuelle des écrans principaux | V6 — **Backlog** | Améliorer la qualité visuelle des 5 écrans principaux : shell (nav groupée, avatar initiales), header dossier (restructuration), liste dossiers (icônes, hover, filtres), dashboard (ombres, relief, urgence), synthèse (accordion amélioré). SF-118-01 : shell + header dossier. SF-118-02 : liste dossiers + dashboard. SF-118-03 : synthèse. |
