...
## 2026-06-14 — run de maturation
- overall 91/100 (Δ 1) → excellent
- ajoutées: 77 features ; modifiées/justifiées et suppressions: voir détail
- directive PO ce run: {"source":"Analyse Claude AI web du 2026-06-14, relayée et endossée par le PO (Franck)","these":"Le produit DRH actuel n'est PAS vendable en l'état : c'est le produit avocat reframé. Insuffisant pour signer un DRH de 200+ salariés à 800-3000 €/mois. 3 trous concrets à combler dans la fiche pour le rendre vendable.","trous":["TROU 1 — TABLEAU DE BORD DU RISQUE SOCIAL CONSOLIDÉ (portefeuille) : un DRH ne gère pas un dossier à la fois, il pilote ~15 dossiers en parallèle et veut voir son EXPOSITION AGRÉGÉE en un coup d'œil (somme des montants estimés, dossiers les plus risqués, échéances procédurales à venir, répartition par type de rupture/site). Vue multi-dossiers cross-workspace, lecture seule, agrège les outils décisionnels existants. Aujourd'hui inexistant (le produit est mono-dossier).","TROU 2 — MODE LECTURE EMPLOYEUR formalisé dans l'UI : changement de LANGAGE, PAS de moteur. Le DRH qui se connecte voit aujourd'hui 'droit du travail / synthèse / questions IA / outils décisionnels' — terminologie qui ne résonne pas. Il veut lire 'risque de condamnation', 'montant estimé de l'exposition', 'points de procédure à sécuriser', 'ce qu'il reste à faire pour sécuriser la rupture'. Ré-étiquetage employeur des écrans/sorties existants, piloté par l'attribut workspace EMPLOYEUR (D7), sans dupliquer le moteur.","TROU 3 — GÉNÉRATION D'ACTES RH : le DRH ne veut pas seulement connaître son risque, il veut PRODUIRE l'acte. Convocation à l'entretien préalable, lettre de licenciement motivée, protocole transactionnel (et au-delà : mise à pied conservatoire, notification de sanction, courrier de réponse, rupture conventionnelle). Le domaine ACTES existe déjà dans le draft mais doit être MUSCLÉ et PRIORISÉ (priorité marché 'high'). Réutiliser le générateur de conclusions/actes existant côté avocat, recadré en actes employeur."],"consigne_run":"Combler ces 3 trous par APPEND justifié (provenance vision-po / concurrent-gap selon le cas) ET améliorer davantage dans la même vision (autres manques qu'un DRH attendrait : ex. alertes d'échéances procédurales sur le portefeuille, export/reporting risque pour le CODIR, traçabilité des actes générés). Respecter l'invariant anti-conflit D8 (conformité/anticipation du risque/sécurisation des procédures — JAMAIS 'gagner contre vos salariés').","garde_fou_gouvernance":"C'est une mise à jour d'HYPOTHÈSE (autorisée). PAS une autorisation de BUILD : le produit DRH-natif reste GATÉ à 2 POC payants. Ne pas confondre l'enrichissement de la fiche avec un ordre de construction."}
